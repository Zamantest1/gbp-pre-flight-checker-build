  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] text-slate-950">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-8 pt-4 sm:px-8 sm:pb-10 sm:pt-6">
        ...
        <div className="grid items-start gap-5 lg:h-[calc(100vh-9rem)] lg:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)] lg:gap-6">
          <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-[0_2px_12px_rgba(15,23,42,0.03)] sm:p-6 lg:h-full lg:overflow-y-auto"><div className="mb-5"><p className="text-base font-bold">Post details</p><p className="mt-1 text-xs text-slate-500">Upload an image and add the caption you plan to publish.</p></div>
