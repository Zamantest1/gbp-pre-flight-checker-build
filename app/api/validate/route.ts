...
Analyze the supplied image and caption. Return ONLY valid JSON with this exact shape:
{
  ...
  "imageQuality": { "status": "Pass|Fail|Warning", "reason": "..." },
  "captionQuality": { "status": "Pass|Fail|Warning", "reason": "..." },
  "localRelevance": { "status": "Pass|Fail|Warning", "reason": "..." },
  "qualityScore": 0,
  "improvedCaption": "...",
  "captionChanges": ["..."],
  "imageSuggestions": ["..."]
